...
`),l.markdown=c[0]&&typeof c[0].getAttribute("data-markdown")=="string"),t.postMessage(JSON.stringify(l),"*")}function a(i){if(function(o){try{return window.location.origin===o.source.location.origin}catch{return!1}}(i)){let o=JSON.parse(i.data);o&&o.namespace==="reveal-notes"&&o.type==="connected"?(clearInterval(d),r()):o&&o.namespace==="reveal-notes"&&o.type==="call"&&function(c,h,l){let p=n[c].apply(n,h);t.postMessage(JSON.stringify({namespace:"reveal-notes",type:"return",result:p,callId:l}),"*")}(o.methodName,o.arguments,o.callId)}}function r(){n.on("slidechanged",s),n.on("fragmentshown",s),n.on("fragmenthidden",s),n.on("overviewhidden",s),n.on("overviewshown",s),n.on("paused",s),n.on("resumed",s),s()}return{id:"notes",init:function(i){n=i,/receiver/i.test(window.location.search)||(window.location.search.match(/(\?|\&)notes/gi)!==null?e():window.addEventListener("message",o=>{if(!t&&typeof o.data=="string"){let h;try{h=JSON.parse(o.data)}catch{}h&&h.namespace==="reveal-notes"&&h.type==="heartbeat"&&(c=o.source,t&&!t.closed?t.focus():(t=c,window.addEventListener("message",a),r()))}var c}),n.addKeyBinding({keyCode:83,key:"S",description:"Speaker notes view"},function(){e()}))},open:e}};export{ht as default};
