<template>
  ...
  <CommonWrapper>
    <template #default>
      <main class="vp-page anzhiyu-about-page" id="main-content" data-type="anzhiyu">
        <DropTransition appear :delay="0.16">
          <div id="page">
            <div id="about-page">
              <div class="author-box">
                <div class="author-tag-left">
                  <span v-for="item in config.avatarSkills.left" :key="item" class="author-tag">{{ item }}</span>
                </div>
                <div class="author-img">
                  <img class="no-lightbox" :src="config.avatarImg" alt="avatar" />
                </div>
                <div class="author-tag-right">
                  <span v-for="item in config.avatarSkills.right" :key="item" class="author-tag">{{ item }}</span>
                </div>
              </div>

              <p class="p center logo large">关于我</p>
              <p class="p center small">{{ config.subtitle }}</p>

              <div class="author-content">
                <div class="author-content-item myInfoAndSayHello">
                  <div class="title1">你好，很高兴认识你</div>
                  <div class="title2">我是 <span class="inline-word">{{ config.name }}</span></div>
                  <div class="title1">{{ config.description }}</div>
                </div>
                <div class="aboutsiteTips author-content-item">
                  <div class="author-content-item-tips">{{ config.aboutsiteTips.tips }}</div>
                  <h2>
              ...
              <div class="author-content">
                <div class="author-content-item skills">
                  <div class="card-content">
                    <div class="author-content-item-tips">{{ config.skillsTips.tips }}</div>
                    <span class="author-content-item-title">{{ config.skillsTips.title }}</span>
                    <div class="skills-style-group">
                      ...
                      <div class="skills-list">
                        <div v-for="skill in config.creativity_list" :key="`skill-${skill.name}`" class="skill-info">
                          <div class="skill-icon" :style="{ background: skill.color }">
                            <img class="no-lightbox" :title="skill.name" :src="skill.icon" :alt="skill.name" />
                          </div>
                ...
                <div class="author-content-item careers">
                  <div class="card-content">
                    <div class="author-content-item-tips">{{ config.careers.tips }}</div>
                    <span class="author-content-item-title">{{ config.careers.title }}</span>
                    <div class="careers-group">
                      <div v-for="career in config.careers.list" :key="career.desc" class="career-item">
                        <div class="circle" :style="{ background: career.color || '#357ef5' }"></div>
              ...
              <div class="author-content">
                <div class="author-content-item personalities">
                  ...
                  <span class="author-content-item-title">{{ config.personalities.author_name }}</span>
                ...
                <div class="author-content-item myphoto">
                  <img class="author-content-img no-lightbox" alt="自拍" :src="config.personalities.photo_url" />
                </div>
              </div>

              <div class="author-content">
                <div class="author-content-item maxim">
                  <div class="author-content-item-tips">{{ config.maxim.maxim_tips }}</div>
                  <span class="maxim-title">
                    <span style="opacity: 0.6; margin-bottom: 8px">{{ config.maxim.maxim_top }}</span>
                    <span>{{ config.maxim.maxim_bottom }}</span>
                  </span>
                </div>
                <div class="author-content-item buff">
                  <div class="card-content">
                    <div class="author-content-item-tips">{{ config.buff.buff_tips }}</div>
                    <span class="buff-title">
                      <span style="opacity: 0.6; margin-bottom: 8px">{{ config.buff.buff_top }}</span>
                      <span>{{ config.buff.buff_bottom }}</span>
                    </span>
                  </div>
                  ...
                  <div class="card-content">
                    ...
                    <div class="content-bottom">
                      <div class="icon-group">
                        <div class="loading-bar" role="presentation" aria-hidden="true" style="display: none"></div>
                      </div>
                      <div class="tips game-yuanshen-uid">{{ config.game.game_uid }}</div>
                    </div>
                  </div>
                </div>
              ...
              <div class="author-content">
                <div class="author-content-item like-technology"
                  ...
                  <div class="card-content">
                    ...
                    <div class="content-bottom">
                      <div class="tips">{{ config.like.like_bottom }}</div>
                    </div>
                  </div>
                </div>
              ...
              <div v-if="sortedRewards.length" class="author-content">
                <div id="about-reward" class="author-content-item single reward">
...
const amountSortedRewards = computed(() =>
  [...config.reward_list].sort((a, b) => b.amount - a.amount)
);

const latestRewardDate = computed(() => sortedRewards.value[0]?.datatime ?? "");

const skillPairs = computed(() => {
  const evenItems = config.creativity_list.filter((_, index) => index % 2 === 0);
  const oddItems = config.creativity_list.filter((_, index) => index % 2 === 1);
  const pairCount = Math.min(evenItems.length, oddItems.length);
...
const duplicatedSkillPairs = computed(() => [
  ...skillPairs.value,
  ...skillPairs.value,
]);
...
const setupWordRotation = (): void => {
  pursuitInterval = setInterval(() => {
    const show = document.querySelector("#about-page span[data-show]");
    const next = show?.nextElementSibling || document.querySelector("#about-page .first-tips");
    const up = document.querySelector("#about-page span[data-up]");
...
const setupHelloMotion = (): void => {
  ...
  helloAboutEl.addEventListener("mousemove", move);
  cleanupMouseMove = () => helloAboutEl.removeEventListener("mousemove", move);
};

const animateYear = (): void => {
  const el = document.getElementById("selfInfo-content-year");
  if (!el) return;

  const target = config.selfInfo.selfInfoContentYear;
  const duration = 2200;
  ...
  const step = (time: number) => {
    ...
    el.textContent = String(Math.round(target * easedProgress));
...
@include layout.page-shell("about", "anzhiyu-about-page");
...
/* About page styles - about-reward section */
/* _extra/reward/about-reward.css */
.about-reward {
  position: absolute;
  top: 1rem;
  right: 2rem;
...
/* About page styles - main about page */
...
.anzhiyu-about-page .author-content {
  display: flex;
  flex-wrap: wrap;
...
.anzhiyu-about-page .author-content-item {
  width: 49%;
  border-radius: 24px;
  background: var(--anzhiyu-card-bg);
  border: var(--style-border-always);
...
.anzhiyu-about-page .inline-word {
  word-break: keep-all;
  white-space: nowrap;
}

.anzhiyu-about-page .author-content-item.aboutsiteTips {
  display: flex;
  justify-content: center;
  align-items: flex-start;
  flex-direction: column;
...
.anzhiyu-about-page .author-content-item.aboutsiteTips h2 {
  margin-right: auto;
  font-size: 36px;
...
.anzhiyu-about-page .author-content-item.aboutsiteTips .mask {
  height: 36px;
  position: relative;
  overflow: hidden;
  margin-top: 4px;
...
.anzhiyu-about-page .author-content-item.aboutsiteTips .mask span {
  display: block;
...
.anzhiyu-about-page .author-content-item.aboutsiteTips .mask span[data-show] {
  transform: translateY(-100%);
  transition: 0.5s transform ease-in-out;
}

.anzhiyu-about-page .author-content-item.aboutsiteTips .mask span[data-up] {
  transform: translateY(-200%);
  transition: 0.5s transform ease-in-out;
}

.anzhiyu-about-page .author-content-item.aboutsiteTips .mask span:nth-child(1) {
  background-image: linear-gradient(45deg, #0ecffe 50%, #07a6f1);
}

.anzhiyu-about-page .author-content-item.aboutsiteTips .mask span:nth-child(2) {
  background-image: linear-gradient(45deg, #18e198 50%, #0ec15d);
}

.anzhiyu-about-page .author-content-item.aboutsiteTips .mask span:nth-child(3) {
  background-image: linear-gradient(45deg, #8a7cfb 50%, #633e9c);
}

.anzhiyu-about-page .author-content-item.aboutsiteTips .mask span:nth-child(4) {
  background-image: linear-gradient(45deg, #fa7671 50%, #f45f7f);
}

@media screen and (max-width: 768px) {
  .anzhiyu-about-page .author-content-item.map {
    margin-bottom: 0;
  }
}
...
.anzhiyu-about-page .author-content-item .card-content {
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
...
.anzhiyu-about-page .author-content-item .card-content .author-content-item-title {
  margin-bottom: 0.5rem;
}

.anzhiyu-about-page .author-content-item .author-content-item-title {
  font-size: 36px;
  font-weight: 700;
  line-height: 1;
}
...
.anzhiyu-about-page .post-tips a {
...
.anzhiyu-about-page .author-content-item .card-content .banner-button-group .banner-button:hover svg {
  background: none !important;
}

.anzhiyu-about-page .author-content-item.personalities {
  width: 59%;
}

.anzhiyu-about-page .author-content-item.personalities .image {
  position: absolute;
  right: 30px;
  top: 10px;
  width: 220px;
...
.anzhiyu-about-page .author-content-item.personalities .image img {
  display: block;
  margin: 0 auto 20px;
  max-width: 100%;
...
.anzhiyu-about-page .author-content-item.personalities:hover .image {
  transform: rotate(-10deg);
}

.anzhiyu-about-page .author-content-item.myphoto {
  height: 60%;
  min-height: 240px;
  position: relative;
  overflow: hidden;
...
.anzhiyu-about-page .author-content-item.myphoto img {
  position: absolute;
  width: 100%;
  height: 100%;
  object-fit: cover;
...
.anzhiyu-about-page .author-content-item.myphoto:hover img {
  transform: scale(1.1);
}

.anzhiyu-about-page .author-content-item:hover .card-background-icon {
  transform: rotate(20deg);
}

.anzhiyu-about-page .author-content-item.personalities .title2 {
  font-size: 36px;
  font-weight: 700;
  line-height: 1.1;
}
...
.anzhiyu-about-page .author-content-item.single {
  width: 100%;
}

.anzhiyu-about-page .author-content-item.map .map-title {
  position: absolute;
  bottom: 0;
  left: 0;
  width: 100%;
...
.anzhiyu-about-page .author-content-item.map .map-title b {
  color: var(--font-color);
}

.anzhiyu-about-page .author-content-item.selfInfo {
  display: flex;
  min-height: 100px;
  max-height: 400px;
  justify-content: space-between;
...
.anzhiyu-about-page .author-content-item.selfInfo div {
  display: flex;
  flex-direction: column;
...
.anzhiyu-about-page .author-content-item.selfInfo .selfInfo-title {
  opacity: 0.8;
  font-size: 12px;
  line-height: 1;
  margin-bottom: 8px;
...
.anzhiyu-about-page .author-content-item.selfInfo .selfInfo-content {
  font-weight: 700;
  font-size: 34px;
  line-height: 1;
}

.anzhiyu-about-page .author-content-item-group.column.mapAndInfo {
  width: 59%;
}

.anzhiyu-about-page .author-content-item.map:hover {
  background-size: 120%;
...
.anzhiyu-about-page .author-content-item.map:hover .map-title {
  bottom: -100%;
}

.anzhiyu-about-page .author-content-item-group.column {
  display: flex;
  flex-direction: column;
  width: 49%;
  justify-content: space-between;
...
.anzhiyu-about-page .post-tips a:hover {
  color: var(--anzhiyu-main) !important;
  background: none !important;
}

.anzhiyu-about-page .author-content-item.single.reward .reward-list-updateDate {
  color: var(--anzhiyu-gray);
  font-size: 14px;
}

.anzhiyu-about-page .author-content-item.maxim {
  font-size: 36px;
  font-weight: 700;
  line-height: 1.1;
  display: flex;
...
.anzhiyu-about-page .author-content-item .author-content-item-tips {
  opacity: 0.8;
  font-size: 12px;
  margin-bottom: 0.5rem;
}

.anzhiyu-about-page .author-content-item.maxim .maxim-title {
  display: flex;
  flex-direction: column;
}

.anzhiyu-about-page .author-content-item.buff {
  height: 200px;
  font-size: 36px;
  font-weight: 700;
  line-height: 1.1;
...
.anzhiyu-about-page .author-content-item.buff .card-content {
  display: flex;
  flex-direction: column;
  justify-content: center;
}

.anzhiyu-about-page .author-content-item.buff .buff-title {
  display: flex;
  flex-direction: column;
}

.anzhiyu-about-page .card-background-icon {
  font-size: 12rem;
  opacity: 0.2;
  position: absolute;
  right: 0;
...
.anzhiyu-about-page .card-background-icon i {
  font-size: 12rem;
}

.anzhiyu-about-page .author-content-item.game-yuanshen {
  background-size: cover;
  min-height: 300px;
  overflow: hidden;
  color: var(--anzhiyu-white);
...
.anzhiyu-about-page .author-content-item .content-bottom {
  margin-top: auto;
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.anzhiyu-about-page .author-content-item .content-bottom .icon-group {
  display: flex;
  position: relative;
}

.anzhiyu-about-page .author-content-item .content-bottom .icon-group i {
...
.anzhiyu-about-page .author-content-item.game-yuanshen::after {
...
.anzhiyu-about-page .author-content-item.comic-content {
  width: 39%;
  min-height: 300px;
  overflow: hidden;
}

.anzhiyu-about-page .author-content-item.comic-content .comic-box {
  display: flex;
  width: 120%;
  height: 100%;
  position: absolute;
...
.anzhiyu-about-page .author-content-item.comic-content .author-content-item-tips,
.anzhiyu-about-page .author-content-item.comic-content .author-content-item-title {
  z-index: 2;
  color: var(--anzhiyu-white);
  pointer-events: none;
}

.anzhiyu-about-page .author-content-item.comic-content .comic-item {
  height: 100%;
  color: #fff;
  width: 20%;
...
.anzhiyu-about-page .author-content-item.comic-content .comic-item:hover {
  width: 46%;
}

.anzhiyu-about-page .author-content-item.comic-content .comic-item:hover .comic-item-cover {
  left: 16%;
  transform: skew(10deg, 0deg) scale(1.6);
}

.anzhiyu-about-page .author-content-item.comic-content .comic-item .comic-item-cover {
  position: absolute;
  top: 0;
  left: -50%;
  height: 100%;
...
.anzhiyu-about-page .author-content-item.comic-content .comic-item .comic-item-cover img {
  height: 100%;
  transition: 0.8s;
  max-width: none;
  border-radius: 0px;
...
.anzhiyu-about-page .author-content-item.comic-content::after {
...
.anzhiyu-about-page .author-content-item.like-technology {
  min-height: 230px;
  color: var(--anzhiyu-white);
}

.anzhiyu-about-page .author-content-item.like-music {
  min-height: 400px;
  color: var(--anzhiyu-white);
  overflow: hidden;
}

.anzhiyu-about-page .author-content-item.like-music::after {
...
@media screen and (max-width: 768px) {
  ...
  [data-theme='dark'] .anzhiyu-about-page .author-content-item .card-content .banner-button-group .banner-button {
  ...
  .anzhiyu-about-page .author-content-item.game-yuanshen .content-bottom {
    padding-bottom: 10px;
  }

  .anzhiyu-about-page .author-content-item.game-yuanshen .game-yuanshen-uid {
    display: none;
  }
  ...
  .anzhiyu-about-page .reward-list-item {
    width: 100% !important;
  }
...
@media screen and (min-width: 768px) and (max-width: 896px) {
  .anzhiyu-about-page .author-content-item.like-music .content-bottom .tips {
    display: none;
  }
}

.anzhiyu-about-page .reward-list-all {
  display: flex;
  flex-wrap: wrap;
  flex-direction: row;
  margin-top: 1rem;
...
.anzhiyu-about-page .reward-list-item .reward-list-item-name {
  font-size: 1rem;
  font-weight: 700;
  line-height: 1;
  margin-bottom: 0.5rem;
...
.anzhiyu-about-page .reward-list-item .reward-list-bottom-group {
  display: flex;
  align-items: center;
  justify-content: space-between;
}

.anzhiyu-about-page .reward-list-item .reward-list-item-money {
  padding: 4px;
...
.anzhiyu-about-page .reward-list-item .reward-list-item-time {
  font-size: 12px;
  color: var(--anzhiyu-secondtext);
  white-space: nowrap;
}

.anzhiyu-about-page .skills {
  display: flex;
  justify-content: center;
  align-items: flex-start;
  flex-direction: column;
...
.anzhiyu-about-page .skills .skill-icon {
  width: 32px;
  height: 32px;
  border-radius: 32px;
  display: flex;
...
.anzhiyu-about-page .skills .skills-list {
  display: flex;
  opacity: 0;
  transition: 0.3s;
  position: absolute;
...
.anzhiyu-about-page .skills .skill-info {
  display: flex;
  align-items: center;
  margin-right: 10px;
  margin-top: 10px;
...
.anzhiyu-about-page .skills .skill-icon img {
  width: 18px;
  height: 18px;
  margin: 0 auto !important;
}

#about-page #skills-tags-group-all .tags-group-icon img {
  width: 60px;
  margin: 0 auto !important;
}

.anzhiyu-about-page .skills .skills-style-group {
  position: relative;
}

.anzhiyu-about-page .skills:hover .skills-style-group #skills-tags-group-all {
  opacity: 0;
}

.anzhiyu-about-page .skills:hover .skills-style-group .skills-list {
  opacity: 1;
}

.anzhiyu-about-page .author-content-item.careers {
  min-height: 400px;
...
.anzhiyu-about-page .author-content-item.careers .careers-group {
  display: flex;
  flex-direction: column;
  height: 100%;
  margin-top: 12px;
...
.anzhiyu-about-page .author-content-item.careers .career-item {
  display: flex;
  justify-content: flex-start;
  align-items: center;
}

.anzhiyu-about-page .author-content-item.careers .career-item .circle {
  width: 16px;
  height: 16px;
  margin-top: 3px;
  margin-right: 8px;
...
.anzhiyu-about-page .author-content-item.careers .career-item .text {
  color: var(--anzhiyu-secondtext);
}

.anzhiyu-about-page .author-content-item.careers .careers-item {
  display: flex;
  align-items: center;
}

.anzhiyu-about-page .author-content-item.careers .careers-item .circle {
  width: 16px;
  height: 16px;
  margin-right: 8px;
  border-radius: 16px;
...
.anzhiyu-about-page .author-content-item.careers .careers-item .name {
  color: var(--anzhiyu-secondtext);
}

.anzhiyu-about-page .author-content-item.careers img {
  position: absolute;
  left: 0;
  bottom: 20px;
  width: 100%;
...
.anzhiyu-about-page .loading-bar {
  position: absolute;
  top: 50%;
  left: 50%;
  width: 500px;
...
.anzhiyu-about-page .loading-bar::after {
  content: '';
  position: absolute;
  top: 500px;
  left: 0;
...
.anzhiyu-about-page .author-content-item.game-yuanshen:hover .loading-bar::after {
...
@supports not (filter: drop-shadow(0 0 0 #fff)) {
  .anzhiyu-about-page .loading-bar:before {
...
[data-theme="dark"] .anzhiyu-about-page #about-page .author-content-item.map.single::before,
[data-theme="dark"] .anzhiyu-about-page #about-page .author-content-item.game-yuanshen::before,
[data-theme="dark"] .anzhiyu-about-page #about-page .author-content-item.like-technology::before,
[data-theme="dark"] .anzhiyu-about-page #about-page .author-content-item.like-music::before {
...
.anzhiyu-about-page #about-page .author-content-item.aboutsiteTips h2 {
  display: grid !important;
  grid-template-columns: auto minmax(6em, 1fr) !important;
  grid-template-areas:
    "title1 mask"
    "title2 mask" !important;
...
.anzhiyu-about-page #about-page .author-content-item.aboutsiteTips .tips-title1 {
  grid-area: title1 !important;
}

.anzhiyu-about-page #about-page .author-content-item.aboutsiteTips .tips-title2 {
  grid-area: title2 !important;
  white-space: nowrap !important;
}

.anzhiyu-about-page #about-page .author-content-item.aboutsiteTips .mask {
...
.anzhiyu-about-page #about-page .author-content-item.aboutsiteTips .mask span {
  top: 1.06em !important;
}

[data-theme="dark"] .anzhiyu-about-page #about-page .author-content-item.aboutsiteTips .tips-title1,
[data-theme="dark"] .anzhiyu-about-page #about-page .author-content-item.aboutsiteTips .tips-title2 {
  color: var(--anzhiyu-fontcolor) !important;
}
...
[data-theme="dark"] body[data-type="about"] main#main-content.anzhiyu-about-page.vp-page #about-page {
...
[data-theme="dark"] body[data-type="about"] main#main-content.anzhiyu-about-page.vp-page .anzhiyu-about-page .author-content-item,
[data-theme="dark"] body[data-type="about"] main#main-content.anzhiyu-about-page.vp-page #about-page .author-tag,
[data-theme="dark"] body[data-type="about"] main#main-content.anzhiyu-about-page.vp-page #about-page .skill-info,
[data-theme="dark"] body[data-type="about"] main#main-content.anzhiyu-about-page.vp-page .anzhiyu-about-page .reward-list-item {
